...
public class DefenseTowerArrowAbilityTests
{
    ...
    [Test]
    public void DefenseTowerArrowContext_BuildsCompositeLaunchData()
    {
    ...
    private static void RegisterArrowEvent(Component arrow, EventInfo eventInfo, string captureMethodName)
    {
        ...
        DynamicMethod dynamicMethod = new(
            ...
            typeof(void),
            parameterTypeArray,
            typeof(DefenseTowerArrowAbilityTests).Module,
            true);
        ILGenerator generator = dynamicMethod.GetILGenerator();
        generator.Emit(
            OpCodes.Call,
            typeof(DefenseTowerArrowAbilityTests).GetMethod(captureMethodName, BindingFlags.Static | BindingFlags.NonPublic));
