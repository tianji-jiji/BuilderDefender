...
/// </summary>
public class DefenseTowerSystem : MonoBehaviour
{
    ...
    private DefenseTowerCardEffectDispatcher ActiveDefenseTowerCardEffectDispatcher => RewardBonusManager.Instance ? RewardBonusManager.Instance.DefenseTowerCardEffectDispatcher : null;
    ...
    private void OnEnable()
    {
        ...
        DefenseTowerTracker.RegisterDefenseTowerSystem(this);
    }

    private void OnDisable()
    {
        RewardBonusManager.OnRewardBonusChanged -= RefreshRewardBonuses;
        DefenseTowerTracker.UnregisterDefenseTowerSystem(this);
        CancelInvoke();
        _hasEnemy = false;
    ...
    {
        ActiveDefenseTowerCardEffectDispatcher?.OnEnemyHit(new DefenseTowerEnemyHitContext(this, hitEnemy, actualDamage));
    }

    // 通知运行时卡牌效果本防御塔击杀了敌人。
    public void NotifyEnemyKilled(Enemy killedEnemy)
    {
        ActiveDefenseTowerCardEffectDispatcher?.OnEnemyKilled(new DefenseTowerEnemyKillContext(this, killedEnemy));
    }
    ...
    private void ExecuteAttack()
    {
        ...
        ActiveDefenseTowerCardEffectDispatcher?.OnBeforeAttack(new DefenseTowerAttackContext(this, _healthSystem));
        bool hasFired = arrowLauncher.FirePrimaryShotGroup(this, targetSelector, _statCalculator, ActiveDefenseTowerCardEffectDispatcher);
        if (!hasFired && TryRefreshTargetsForImmediateShot())
        {
            hasFired = arrowLauncher.FirePrimaryShotGroup(this, targetSelector, _statCalculator, ActiveDefenseTowerCardEffectDispatcher);
        }
    ...
    private void HandleAttackTriggeredRewards()
    {
        ...
        ActiveDefenseTowerCardEffectDispatcher?.OnAfterAttack(attackContext);
        arrowLauncher.FireExtraAttackArrows(attackContext.ExtraAttackCount, this, targetSelector, _statCalculator, ActiveDefenseTowerCardEffectDispatcher);
    }
    ...
    private void RefreshRewardBonuses()
    {
        ...
        _currentStats = _statCalculator.RefreshStats(ActiveDefenseTowerCardEffectDispatcher);
