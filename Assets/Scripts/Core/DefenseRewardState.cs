...
/// <summary>
/// 防御塔奖励运行时状态，负责保存本局已经获得的防御塔奖励数值。
/// </summary>
public class DefenseRewardState
{
    ...
    private readonly List<DefenseAttackHealthCostRule> _attackHealthCostRuleList = new List<DefenseAttackHealthCostRule>();
    ...
    public IReadOnlyList<DefenseExtraAttackRule> ExtraAttackRuleList => _defenseExtraAttackRuleList;
    ...
    public IReadOnlyList<DefenseAttackHealthCostRule> AttackHealthCostRuleList => _attackHealthCostRuleList;
    ...
    public void AddAttackHealthCostRule(int triggerAttackCount, int healthCost)
    {
        ...
        _attackHealthCostRuleList.Add(new DefenseAttackHealthCostRule(triggerAttackCount, healthCost));
    }
