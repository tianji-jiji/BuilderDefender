...
/// </summary>
public class TowerActiveRewards
{
    ...
    private readonly List<TowerExtraAttackRule> _defenseTowerExtraAttackRuleList = new();
    ...
    public IReadOnlyList<TowerExtraAttackRule> ExtraAttackRuleList => _defenseTowerExtraAttackRuleList;
    ...
    public IReadOnlyList<TowerAttackHealthCostRule> AttackHealthCostRuleList => _attackHealthCostRuleList;
    ...
    public float GetExtraAttackPowerMultiplier()
    {
        ...
        foreach (TowerExtraAttackRule extraAttackRule in _defenseTowerExtraAttackRuleList)
        {
    ...
    public void AddExtraAttackRule(int triggerAttackCount, int extraAttackCount)
    {
        ...
        _defenseTowerExtraAttackRuleList.Add(new TowerExtraAttackRule(triggerAttackCount, extraAttackCount));
    }
    ...
    public bool IsFinalDefenseActive()
    {
        ...
        return TowerRegistry.HomeHealthNormalized <= _finalDefenseHomeHealthThreshold;
    }
