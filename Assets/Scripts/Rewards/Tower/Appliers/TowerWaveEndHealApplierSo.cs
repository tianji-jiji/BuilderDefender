...
public class TowerWaveEndHealApplierSo : TowerRewardApplierSo, ITowerWaveCompletedTrigger
{
    // 应用波末回血比例。
    ...
    // 在波次结束时治疗所有防御塔。
    public void OnWaveCompleted(TowerRewardRuntimeState runtimeState)
    {
        ...
        TowerWaveEndExecutor.ApplyWaveEndHeal(healPercent);
    }
}
