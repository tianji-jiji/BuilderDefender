...
public class TowerKillGrowthApplierSo : TowerRewardApplierSo, ITowerEnemyKilledTrigger
{
    ...
    // 按击杀次数自动提升防御塔星级。
    public void OnEnemyKilled(TowerEffectState runtimeState, TowerEnemyKilledContext context)
    {
        ...
        runtimeState.World?.UpgradeTowerOneLevel(sourceTowerCombatSystem);
    }
}
