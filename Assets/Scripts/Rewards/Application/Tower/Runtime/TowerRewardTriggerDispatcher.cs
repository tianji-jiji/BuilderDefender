...
/// </summary>
public sealed class TowerRewardTriggerDispatcher
{
    private readonly ITowerRewardWorld _world;
    private readonly List<TowerEffectState> _runtimeStateList = new();
    ...
    public void ClearSource(TowerCombatSystem sourceTowerCombatSystem)
    {
        ...
        foreach (TowerEffectState runtimeState in _runtimeStateList)
        {
    ...
    private class TriggerRegistration<T> where T : class, ITowerRuntimeReward
    {
        ...
        public TowerEffectState RuntimeState { get; }

        public TriggerRegistration(T trigger, TowerEffectState runtimeState)
        {
            Trigger = trigger;
