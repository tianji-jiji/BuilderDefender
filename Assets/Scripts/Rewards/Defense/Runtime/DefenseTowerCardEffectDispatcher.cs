...
/// <summary>
/// 防御塔卡牌效果分发器，负责按获得顺序分发战斗生命周期钩子。
/// </summary>
public class DefenseTowerCardEffectDispatcher
{
    ...
    // 注册一条可运行时生效的防御塔卡牌效果。
    public void RegisterEffect(IDefenseTowerCardEffect effect, RewardEffectConfig config)
    {
