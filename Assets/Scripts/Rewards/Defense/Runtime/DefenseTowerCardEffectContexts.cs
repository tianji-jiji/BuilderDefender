...
public class DefenseTowerStatsContext
{
    ...
    public DefenseTowerStatsContext(DefenseTowerSystem sourceDefenseTowerSystem, int attackDamage, float arrowGenerateRate, float detectRadius)
    {
...
public class DefenseTowerAttackContext
{
    ...
    public DefenseTowerAttackContext(DefenseTowerSystem sourceDefenseTowerSystem, HealthSystem sourceHealthSystem)
    {
        SourceDefenseTowerSystem = sourceDefenseTowerSystem;
...
public class DefenseTowerEnemyHitContext
{
    ...
    public DefenseTowerEnemyHitContext(DefenseTowerSystem sourceDefenseTowerSystem, Enemy hitEnemy, int actualDamage)
    {
        SourceDefenseTowerSystem = sourceDefenseTowerSystem;
        HitEnemy = hitEnemy;
...
public class DefenseTowerEnemyKillContext
{
    ...
    public DefenseTowerEnemyKillContext(DefenseTowerSystem sourceDefenseTowerSystem, Enemy killedEnemy)
    {
        SourceDefenseTowerSystem = sourceDefenseTowerSystem;
