...
/// <summary>
/// 防御塔奖励加成集合，负责保存本局已经获得的防御塔持续数值和规则。
/// </summary>
public class DefenseTowerRewardModifiers
{
    ...
    public bool IsFinalDefenseActive()
    {
        ...
        return DefenseTowerTracker.HomeHealthNormalized <= _finalDefenseHomeHealthThreshold;
    }
