...
/// </summary>
public abstract class DefenseTowerRewardApplierSo : RewardEffectApplierSo, IDefenseTowerRuntimeEffect
{
    ...
    // 尝试取得防御塔奖励加成集合。
    protected bool TryGetDefenseTowerRewardState(RewardEffectApplyContext applyContext, out DefenseTowerRewardState defenseTowerRewardState)
    {
        defenseTowerRewardState = applyContext?.DefenseTowerRewardState;
        return defenseTowerRewardState != null;
    }
