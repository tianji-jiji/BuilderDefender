...
public class RewardSummaryPanel : MonoBehaviour
{
    ...
    private void RefreshRecordList()
    {
        ...
        _coordinator = _coordinator ? _coordinator : RewardRuntimeCoordinator.Instance;
        if (_coordinator?.History == null || !recordRoot || !recordItemPrefab)
        {
            return;
        }

        IReadOnlyList<RewardCardRecord> rewardRecordList = _coordinator.History.RecordList;
        foreach (RewardCardRecord rewardRecord in rewardRecordList)
        {
